...
class Episciences_Submit
{
    ...
    public static function getForm(array $settings = [], $defaults = null, bool $isForwardService = false): \Ccsd_Form
    {
        ...
        if($isForwardService){
            ...
            $form->addElement('hidden', 'forward_uri', [
                'value' => $defaults['forwardUri']
            ]);
        }
