...
return [
    ...
    "Assigner tous les rédacteurs de la section" => "Assign all section editors",
    ...
    "Délai de relecture par défaut" => "Default rating delay",
    "Délai de relecture minimum" => "Minimum rating delay",
    "Délai de relecture maximum" => "Maximum rating delay",
    "Minimum de relectures requis" => "Minimum ratings count",
    "Nombre minimum de relectures avant de pouvoir accepter un article." => "Minimum ratings count required for accepting an article.",
    "Vous devez saisir une estimation de temps valide." => "Invalid estimated time",
    "Le délai de relecture par défaut ne peut pas être supérieur au délai de relecture maximum." => "Default rating deadline cannot be greater than maximum rating deadline",
    "Le délai de relecture par défaut ne peut pas être inférieur au délai de relecture minimum." => "Default rating deadline cannot be lesser than minimum rating deadline",
    "Le délai de relecture minimum ne peut pas être supérieur au délai de relecture maximum." => "Minimum rating deadline cannot be greater than maximum rating deadline",
    "Le délai de relecture maximum ne peut pas être inférieur au délai de relecture minimum." => "Maximum rating deadline cannot be lesser than minimum rating deadline",
    "Votre délai estimé de relecture dépasse le délai fixé par le comité éditorial." => "Your estimated rating delay is beyond the deadline set by the editorial board",
    ...
    "Délai laissé au relecteur pour rendre son rapport d'évaluation. La date limite est calculée à partir de la date d'envoi de l'invitation." =>
        "Delay before the reviewer has to send the rating report. The deadline is calculated from the date when the invitation was sent.",
    "Les rédacteurs ont la possibilité de modifier le délai de relecture pour chacun des relecteurs d'un article dont ils ont la charge. Ce délai modifié ne peut pas être inférieur au paramètre <strong>Délai de relecture minimum</strong>." =>
        "When handling an article, editors can set a custom rating delay for each reviewer. This delay cannot be lesser than the <strong>Minimum rating delay</strong>.",
    "Les rédacteurs ont la possibilité de modifier le délai de relecture pour chacun des relecteurs d'un article dont ils ont la charge. Ce délai modifié ne peut pas être supérieur au paramètre <strong>Délai de relecture maximum</strong>." =>
        "When handling an article, editors can set a custom rating delay for each reviewer. This delay cannot be greater than the <strong>Maximum rating delay</strong>.",
    ...
    "Vous n'avez pas les droits suffisants pour changer le statut de cette relecture" => "You don't have the required permissions to change the status of this rating",
    ...
    "Vous ne pouvez pas accepter cet article, car le nombre minimum de relectures (%s) n'a pas été atteint." => "You cannot accept this article, because the required number of ratings (%s) has not been reached.",
    "Vous ne pouvez pas refuser cet article, car le nombre minimum de relectures (%s) n'a pas été atteint." => "You cannot decline this article, because the required number of ratings (%s) has not been reached.",
    "Vous ne pouvez faire de demande de modifications, car le nombre minimum de relectures (%s) n'a pas été atteint." => "You cannot ask for revision, because the required number of ratings (%s) has not been reached.",
    ...
    "classique" => "standard",
    "La nouvelle grille a bien été enregistrée." => "The new rating grid has been successfully saved.",
    ...
    "relecture en attente" => 'pending reviewing',
    "invitation en attente" => 'unanswered rating invitation',
    "invitation obsolète" => 'obsolete rating invitation',
    'relecture obsolète' => 'obsolete rating',
    'relectures obsolètes' => 'obsolete ratings',
    ...
    "Vous pouvez dès à présent commencer votre relecture si vous le souhaitez." => "You can start your reviewing as soon as you want.",
    ...
    "Votre évaluation a bien été enregistrée." => "Your rating has been saved.",
    "Votre évaluation n'a pas pu être enregistrée." => "Your rating could not be saved.",
    ...
    "La grille d'évaluation n'est pas encore disponible" => "The rating grid is not available yet",
    "vous" => 'you',
    "l'auteur" => "the author",
    "relecteur" => "reviewer",
    ...
    "État de ma relecture" => 'Progression of my reviewing',
    "Statut de ma relecture" => 'Progression of my reviewing',
    ...
    Episciences_Paper_Logger::CODE_REVIEWING_IN_PROGRESS => "Reviewing in progress",
    Episciences_Paper_Logger::CODE_REVIEWING_COMPLETED => "Completed reviewing",
    ...
    Episciences_Paper_Logger::CODE_MONITORING_REFUSED => 'Article monitoring refused',
    ...
    "Erreurs" => "Errors",
    "La nouvelle date limite de rendu de relecture doit être supérieure à : " => "The new reviewing deadline must be superior to: ",
    "La date limite de rendu de relecture est invalide" => "The new reviewing deadline is invalid",
    "La date limite de rendu de relecture est obligatoire" => "The reviewing deadline is mandatory",
    ...
    "Le status de la relecture a été changé avec succès" => 'The status of this rating has been successfully updated',
    ...
    "file-tmp" => "Access the temporary versio nof a document",
    "grid-add" => "Reviewing grid: Create a grid",
    "grid-addcriterion" => "Reviewing grid: Add a criterion",
    "grid-addseparator" => "Reviewing grid: Add a separator",
    "grid-copy" => "Reviewing grid: Copy default grid",
    "grid-delete" => "Reviewing grid: Delete a grid",
    "grid-deletecriterion" => "Reviewing grid: delete a criterion",
    "grid-editcriterion" => "Reviewing grid: edit a criterion",
    "grid-editseparator" => "Reviewing grid: edit a separator",
    "grid-list" => "Reviewing grid: list all grids",
    "grid-view" => "Reviewing grid: display a grid",
    ...
    "Articles à relire" => 'Articles waiting for reviewing',
    ...
    "soumis" => "submitted",
    "soumis aux relecteurs" => "waiting for reviewing",
    "en attente de relecture" => "waiting for reviewing",
    ...
    "Cet article a déjà été soumis et il est en cours de relecture." => "This article has been submitted and is waiting for reviewing.",
    ...
    "Le log de l'invitation de relecteur n'a pas pu être enregistré" => "The log of the reviewer invitation could not be registered",
    ...
    "Invitation à la relecture d'un article" => "Paper reviewing invitation",
    ...
    "Délai avant remise de la relecture, une fois l'invitation acceptée :" => "Delay before rating delivery, once the invitation has been accepted:",
    ...
    "article en attente de relecture" => 'article waiting for reviewing',
    "articles en attente de relecture" => 'articles waiting for reviewing',
    ...
    "relecture en cours" => 'reviewing in progress',
    "relectures en cours" => 'reviewings in progress',
    "relecture terminée" => 'completed reviewing',
    "relectures terminées" => 'completed reviewings',
    "relecture" => 'reviewing',
    "relectures" => 'reviewings',
    "Mes relectures" => 'My reviewings',
    "à relire" => 'waiting to be reviewed',
    "Toutes mes relectures" => "All my reviewings",
    "Relectures en cours" => "Reviewings in progress",
